...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    foreach ($available_vehicles as $vehicle) {
        if ($vehicle['vehicle_id'] == $selected_vehicle) {
            ...
            $rental_price = $duration_hours * 50;
    ...
    // Update is_rented status in the Vehicle table for the reserved vehicle
            ...
            <div class="vehicle-list">
                <?php foreach ($available_vehicles as $vehicle): ?>
                    <?php
                        ...
                        // Calculate rental and total prices
                        $vehicle_price = $vehicle['vehicle_price'];
                        $rental_price = $duration_hours * 50;
                        $total_price = $vehicle_price + $rental_price;
                    ?>
                    <div class="vehicle-card">
                        ...
                        <label for="vehicle_<?php echo htmlspecialchars($vehicle['vehicle_id']); ?>">
                            ...
                            <div class="price-breakdown">
                                <p>Vehicle Price: ₹<?php echo number_format($vehicle_price, 2); ?></p>
                                <p>Rental Price (for <?php echo $duration_hours; ?> hours): ₹<?php echo number_format($rental_price, 2); ?></p>
